...
Sexto projeto de Front-End fornecido pela instituição Trybe, onde aplicamos nossos conhecimentos com o RTL.


## Aprendizados

Aprendi sobre o RTL, além de Mocks e teste de inputs.
...
```bash
  git@github.com:GuilhermeFMP/Trybe-React-Testing-Library.git
